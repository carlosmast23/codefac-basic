/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     11/03/2016 16:58:17                          */
/*==============================================================*/
...
alter table DETALLE_ORDEN_TRABAJO add constraint FK_REFERENCE_36 foreign key (ID_ORDEN_TRABAJO)
      references ORDEN_TRABAJO (ID_ORDEN_TRABAJO) on delete restrict on update restrict;

alter table DETALLE_ORDEN_TRABAJO add constraint FK_REFERENCE_37 foreign key (CODIGO_SERVICIO)
      references SERVICIOS (CODIGO_SERVICIO) on delete restrict on update restrict;
...
alter table DETALLE_PRODUCTO_ORDEN_TRABAJO add constraint FK_REFERENCE_38 foreign key (ID_ORDEN_TRABAJO)
      references DETALLE_ORDEN_TRABAJO (ID_ORDEN_TRABAJO) on delete restrict on update restrict;
