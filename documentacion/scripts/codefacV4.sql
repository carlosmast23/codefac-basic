/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     05/02/2016 12:17:15                          */
/*==============================================================*/
...
alter table PRODUCTO_GENERAL_VENTA add constraint FK_REFERENCE_29 foreign key (CODIGO_RESERVA_PROD_GENERAL)
