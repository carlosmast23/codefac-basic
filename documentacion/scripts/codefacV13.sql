/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     29/04/2016 15:17:01                          */
/*==============================================================*/


drop table if exists ABONO_VENTA_CREDITO;

drop table if exists ACCESORIOS_ORDEN_TRABAJO;
...
/*==============================================================*/
/* Table: ACCESORIOS_ORDEN_TRABAJO                              */
/*==============================================================*/
create table ACCESORIOS_ORDEN_TRABAJO
(
   ID_ACCESORIOS_ORDEN_TRABAJO int not null auto_increment,
   ...
   ESTADO               varchar(32),
   primary key (ID_ACCESORIOS_ORDEN_TRABAJO)
);
...
(
   ...
   LICENCIA             varchar(64),
   EMAIL_SERVICIO_TECNICO varchar(64),
   CLAVE_EMAIL_SERVICIO_TECNICO varchar(64),
...
alter table ACCESORIOS_ORDEN_TRABAJO add constraint FK_REFERENCE_57 foreign key (ID_DETALLE_ORDEN_TRABAJO)
...
alter table DETALLE_ORDEN_TRABAJO add constraint FK_REFERENCE_46 foreign key (USU_EMPLEADO)
      references USUARIO (NICK) on delete restrict on update restrict;
...
alter table DETALLE_VENTA_ORDEN_TRABAJO add constraint FK_REFERENCE_48 foreign key (ID_DETALLE_ORDEN_TRABAJO)
      references DETALLE_ORDEN_TRABAJO (ID_DETALLE_ORDEN_TRABAJO) on delete restrict on update restrict;
